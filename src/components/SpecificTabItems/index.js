...
class SpecificTabItems extends Component {
  render() {
    const {specificTabId, getSelectedImg} = this.props
    const filteredImages = imagesList.filter(
      item => item.category === specificTabId,
    )
    return (
      <ul>
...
export default SpecificTabItems
