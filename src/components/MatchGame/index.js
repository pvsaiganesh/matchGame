...
import './index.css'
import SpecificTabItems from '../SpecificTabItems'
...
class MatchGame extends Component {
  ...
  getId = selectedTabId => {
    this.setState({tabId: selectedTabId})
  }

  render() {
    const {score, time, tabId, showScore, questionObj} = this.state
    return (
      <div className="bg">
        {showScore ? (
          ...
          <div>
            ...
            <div>
              <img src={questionObj.imageUrl} alt="match" />
            </div>
            ...
            <div>
              <SpecificTabItems
                specificTabId={tabId}
                getSelectedImg={this.getSelectedImg}
              />
            </div>
          </div>
        )}
